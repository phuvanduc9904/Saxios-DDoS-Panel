...
if (process.argv.length < 8) {
  ...
  console.log('                          -------------------------------------------');
  console.log(`
    ${colored(colors.COLOR_BRIGHT_CYAN, 'PUPPETEER v1.2')} | Latest update For Captcha  , Speed Captcha Solving With More Options Added Can Help The Solution Become More Optimized
